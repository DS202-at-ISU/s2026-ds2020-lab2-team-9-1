...
![](README_files/figure-gfm/unnamed-chunk-8-1.png)<!-- --> This is a
right skewed distribution. Most of the data is concentrated from 0 to 1,
outliers at around 8 and 12 acres. Majority of the observations have
very small amount of acres.
...
The scatterplot shows the relationship between 2 variables, Acres and
Sale Price. There is no clear positive relationship between the 2
variables. Points are concentrated at around 0-1 acres. This is a weak
correlation. Data is very cluttered at the bottom left corner.
...
The variable Year Built ranges from about 1870 to around 2020 after
removing the invalid value of 0. The scatterplot of Sale Price vs Year
Built shows a slight positive relationship, meaning that houses built
more recently tend to have higher sale prices. Most homes are
concentrated between about 1950 and 2010 with moderate prices. However,
there are a few clear outliers where houses built around the early 2000s
have extremely high sale prices compared to the rest. These outliers
help explain some of the unusually high values that appeared in the
histogram of Sale Price in Step 3.
...
![](README_files/figure-gfm/unnamed-chunk-14-1.png)<!-- --> Range of
...
![](README_files/figure-gfm/unnamed-chunk-15-1.png)<!-- --> There isn’t
